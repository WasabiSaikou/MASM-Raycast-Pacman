...
NODE_H_COST    EQU 6    ; 2 Bytes  | DW: H 值 (曼哈頓距離的估計成本)3
...
PUBLIC GHOST_POS_X, GHOST_POS_Y, TARGET_POS_X, TARGET_POS_Y
PUBLIC GHOST_STATE  ; 來自 pathFinding.asm 的 GHOST_STATE 應移至此處
...
GHOST_STATE DB 0  ; 0=追逐, 1=逃跑 (這是 pathFinding.asm 開頭的變數)
